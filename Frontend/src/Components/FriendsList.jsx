    ...
    <div className=" my-4  card bg-base-200 p-2 hover:shadow-md transition-shadow">
      ...
      <div className="flex mb-5 items-center justify-start gap-2">
        <div className="flex text-sm px-3 py-1  rounded-full bg-primary badge badge-secondary items-center justify-center gap-1">
          ...
          <p className="text-black text-[10px] md:text-sm capitalize">
        ...
        <div className="flex border text-sm badge badge-outline px-3 py-1 rounded-full items-center justify-center gap-1">
          ...
          <p className="capitalize text-[10px] md:text-sm">Learning : {props.learningLanguage}</p>
        </div>
      </div>
      ...
      {props.recommended ? (
        ...
        <p className="line-clamp-1 mb-5">{props.bio}</p>
         ...
         disabled ={hasSentRequest || props.isPending} className={`${hasSentRequest ? "opacity-20 bg-white/5 w-full border border-white/10  flex items-center justify-center gap-2 md:p-4 md:py-3 md:my-2 p-2 py-2 my-1 text-white  cursor-pointer  rounded-full" : "w-full border hover:border-white/100 border-primary/0 flex items-center justify-center gap-2 md:p-4 md:py-3 md:my-2 p-2 py-2 my-1 hover:bg-primary/0 hover:text-white hover:border cursor-pointer bg-primary text-black rounded-full"}`}>
            {hasSentRequest ? <>
        ...
        <>
         <Link to={`/chat/${props._id}`}>
          <button  className="w-full p-2 py-2 my-1 md:p-4 md:py-3 md:my-2 border cursor-pointer hover:bg-primary hover:text-black rounded-full">
            Message
          </button>
         </Link>
        </>
