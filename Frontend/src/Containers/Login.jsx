  ...
  const handleLogin = (e) =>{
   ...
   return (
    <>
      ...
      >
        <h1 className="xl:text-4xl lg:text-3xl text-2xl font-bold my-4  font-mono ">Sign in</h1>
        <div className="flex text-gray-200 items-center justify-between  overflow-hidden w-[80%] md:w-[95%] lg:w-[80%] xl:w-[60%] h-[70vh] border border-gray-700  rounded-4xl">
          {/* Signup Left side */}
          <form
          ...
          >
            <div className="flex  items-center">
              <ShipWheelIcon className="xl:size-9 lg:size-8 size-7  mr-3 text-[#1fb854]" />
              <h1 className="xl:text-3xl lg:text-2xl text-xl text-[#1fb854] font-mono font-semibold">
                Streamify
              </h1>
            </div>
            <div>
