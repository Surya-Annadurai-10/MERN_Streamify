            ...
            <div>
              ...
              {acceptedRequests.map((req) => {
                ...
                return (
                  <div
                    key={req._id}
                    className="card   lg:w-[50%]  bg-base-200 p-4 my-4 hover:shadow-md transition-shadow"
                  >
                    <div className="flex mb-5   items-center justify- gap-4">
                      <div className="w-[50px] h-[50px] rounded-full">
                        <img
                      ...
                      <div className="md:flex items-center justify-between w-[100%]">
                        <div>
                          <h1 className="font-semibold text-sm lg:text-md ">{req.recipient.username}</h1>
                        ...
                        <div className="flex mt-3 lg::mt-0 items-center gap-2 badge badge-primary">
