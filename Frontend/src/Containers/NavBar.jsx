      ...
      <div className="flex  items-center">
        {isChatPage && (
          <>
            ...
            <h1 className="lg:text-3xl md:text-2xl hidden md:block bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary tracking-wider  font-mono font-semibold">
              Streamify
            </h1>
          </>
        )}
