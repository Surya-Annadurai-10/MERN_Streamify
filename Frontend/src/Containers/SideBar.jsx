...
const SideBar = () => {
  ...
  return (
    ...
    <div
      // data-theme="coffee"
      className="min-h-[100vh] lg:flex hidden bg-primary/5 shadow-2xl relative   items-center justify-start flex-col gap-4 w-[15%] \"
    >
...
{/* Lg screen sidebar */}
    <div
      // data-theme="coffee"
      className="min-h-[100vh] lg:hidden flex bg-primary/5 shadow-2xl relative   items-center justify-start flex-col gap-4 min-w-[60px] "
    >
     <Link to={"/"}>
      ...
      <div className="w-[100%] flex items-center h-[30%] justify-center gap-3 flex-col">
        <Link
          className={`${
            currentPath == "/" ? "bg-primary/30" : ""
          }  p-3 flex gap-2 text-base-content opacity-70 hover:bg-primary/10   rounded-full `}
          to={"/"}
        >
          <Home size="20" />
          {/* <span className="">Home</span> */}
      ...
      <div className=" lg:flex flex-col gap-2 absolute left-3.5 bottom-10 ]">
        <div>
          <img
            className="w-[35px]"
            src={authUser.user.profilePicture}
        ...
        <div className="">
          <h1 className="text-md lg:block hidden  capitalize">{authUser.user.username}</h1>
