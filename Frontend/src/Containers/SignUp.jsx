...
const SignUp = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="xl:text-4xl lg:text-3xl text-2xl  font-bold my-4  font-mono ">Sign Up</h1>
        <div className="flex text-gray-200 items-center justify-between  overflow-hidden w-[90%] lg:w-[80%] h-[70vh] xl:w-[60%] border border-gray-700  rounded-4xl">
          {/* Signup Left side */}
          <form
          ...
          >
            <div className="flex  items-center">
              <ShipWheelIcon className="xl:size-9 lg:size-8 size-7   mr-3 text-primary" />
              <h1 className="xl:text-3xl lg:text-2xl text-xl bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary tracking-wider font-mono font-semibold">
                Streamify
              </h1>
            </div>
            <div>
